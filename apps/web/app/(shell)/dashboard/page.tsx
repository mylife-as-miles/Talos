...
import { Box, Brain, ChevronsUp, CirclePlay, Crosshair, Filter, Info, ShieldAlert } from "lucide-react";
...
function MetricSparkline({ tone = "cyan" }: { tone?: "cyan" | "red" }) {
  ...
  return (
    <svg viewBox="0 0 232 40" className="talos-sparkline mt-3 h-10 w-full" aria-hidden>
...
function MetricCard({
  ...
  return (
    <section className={`talos-panel talos-card-hover talos-fade-up ${stagger} rounded-lg p-5`}>
  ...
  return (
    <>
      ...
      <div className="mt-7 grid gap-3 xl:grid-cols-4">
        ...
        />
        <section className="talos-panel talos-card-hover talos-fade-up talos-stagger-4 rounded-lg p-5">
      ...
      <div className="mt-3 grid gap-5 xl:grid-cols-[1.45fr_1fr]">
        <section className="talos-panel talos-card-hover talos-fade-up talos-stagger-3 rounded-lg p-5">
